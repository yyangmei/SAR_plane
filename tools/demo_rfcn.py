...
def demo(net, image_name):
    ...
    for cls_ind, cls in enumerate(CLASSES[1:]):
        ...
        keep = soft_nms(dets, sigma=0.5, Nt=0.3, method=1, threshold=0.3)
        dets = dets[keep, :]
...
if __name__ == '__main__':
    ...
    caffemodel = 'output/rfcn_end2end_ohem/voc_2007_trainval/resnet101_deform_iter_46000.caffemodel'
